...
<div class="relative isolate overflow-hidden bg-white-900 py-24 sm:py-32">
  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    <div class="mx-auto max-w-2xl lg:mx-0">
      ...
      <p class="mt-6 text-lg leading-8 text-gray-300">Passionate, Innovative, And Customer-Centric, Our Software Development Team Is Dedicated To Delivering High-Quality Products That Meet The Needs Of Our Users.</p>
    </div>
