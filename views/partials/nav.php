        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8" src="https://api.dicebear.com/7.x/adventurer/svg?seed=coco"
                         alt="myCompany">
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/"
                           class="<?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-white-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Home</a>
                        <a href="/about"
                        ...
                        <?php if ($_SESSION['user'] ?? false) : ?>
                            <a href="/blogs"
                               class="<?= urlIs('/blogs') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">blogs</a>
                        <?php endif ?>
                    </div>
                </div>
            </div>
                    ...
                    <?php if ($_SESSION['user'] ?? false) : ?>
                        <div class="relative ml-3">
                            <button type="button"
                                ...
                                <img class="h-8 w-8 rounded-full bg-blue-800"
    ...
    <div class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pt-4 pb-3">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white"><?= $_SESSION['user'] ?? ''; ?></div>
                    <div class="text-sm font-medium leading-none text-gray-400"> <?= $_SESSION['user']?? ''; ?> x.y@gmail.com  </div>
                </div>
                <button type="button"
